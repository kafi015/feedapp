...
class CustomerInfoUpdateScreen extends StatefulWidget {
  const CustomerInfoUpdateScreen({Key? key}) : super(key: key);

  @override
  State<CustomerInfoUpdateScreen> createState() => _CustomerInfoUpdateScreenState();
}
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: AppElevatedButton(text: "Update", textColor: Colors.white, buttonColor: Colors.blue, onTap: (){}),
            ),
          ],
        ),
      ),
